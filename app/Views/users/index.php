        ...
        <div class="col-12">
          <div class="card mb-4 shadow-lg">
            <div class="card-header pb-0">
              <h6>Data User TK Sarinah</h6>
            </div>
            <a href="<?php echo base_url('users/create'); ?>" class="btn btn-primary float-right"><i class="nav-icon fas fa-plus-square"></i> Tamba Data Baru</a>
                    ...
                    <?php foreach ($users as $key => $row) { ?>
                      <tr>
                        ...
                        <td style="text-align: center">
                          ...
                          <div id="newDataBadge" class="badge bg-primary" style="display: none;">Pendaftar Baru</div>
...
function hideFlashMessages() {
    ...
    if (successAlert) {
      ...
      }, 3000); // Menghilangkan pesan sukses setelah 30 detik (30000 milidetik)
    }

    if (infoAlert) {
      setTimeout(function () {
        infoAlert.style.display = 'none';
      }, 3000); // Menghilangkan pesan info setelah 30 detik (30000 milidetik)
    }

    if (warningAlert) {
      setTimeout(function () {
        warningAlert.style.display = 'none';
      }, 3000); // Menghilangkan pesan peringatan setelah 30 detik (30000 milidetik)
    }
  }
    ...
    deleteButtons.forEach(function (button) {
        button.addEventListener("click", function () {
            ...
            deleteLink.href = "<?php echo base_url('users/delete/'); ?>" + id;
        });
    });
